...
describe('useLocalStorageState()', () => {
    ...
    it(`initial state isn't written into sessionStorage`, () => {
    ...
    it('does not fail when having an invalid data in sessionStorage', () => {
    ...
    it('updating writes into sessionStorage', () => {
        const { result } = renderHook(() =>
            useLocalStorageState('todos', { defaultValue: ['first', 'second'] }),
        )
    ...
    it(`unrelated storage update doesn't do anything`, () => {
        ...
        act(() => {
            ...
            sessionStorage.setItem('not-todos', JSON.stringify(['third', 'forth']))
            window.dispatchEvent(
                new StorageEvent('storage', {
                    storageArea: sessionStorage,
                    key: 'not-todos',
    ...
    it('handles errors thrown by sessionStorage', () => {
    ...
    it('isPersistent returns false when sessionStorage.setItem() throws an error', () => {
        const mock = jest.spyOn(Storage.prototype, 'setItem').mockImplementation(() => {
            throw new Error()
        })
    ...
    it('isPersistent becomes false when sessionStorage.setItem() throws an error on consecutive updates', () => {
        const { result } = renderHook(() =>
            useLocalStorageState('todos', { defaultValue: ['first', 'second'] }),
        )
    ...
    it(`when defaultValue isn't provided — don't write to sessionStorage on initial render`, () => {
    ...
    it(`sessionStorage value shouldn't be overwritten`, () => {
    ...
    it('if there are already items in sessionStorage', () => {
